...
I. Страница Main (+60):
  ...
  1. Проверка верстки (+7):
    ...
    - верстка страницы валидная (Проверка сервисом https://validator.w3.org/): +4;
  ...
  4. Интерактивность элементов (+12):
    ...
    - выполнена интерактивность ссылок и кнопок. Интерактивность заключается не только в изменении внешнего вида курсора, но и в использовании и других визуальных эффектов согласно стайлгайду в макете: +2
